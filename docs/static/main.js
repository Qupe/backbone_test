...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _workarea = __webpack_require__(7);
	...
	var _workarea3 = __webpack_require__(17);
	
	var _workarea4 = _interopRequireDefault(_workarea3);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var App = _backbone2.default.View.extend({
	    ...
	    initialize: function initialize() {
	        this.workarea = new _workarea2.default({
	            model: new _workarea4.default()
	        });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _picture = __webpack_require__(8);
	...
	var _picture3 = __webpack_require__(14);
	
	var _picture4 = _interopRequireDefault(_picture3);
	
	var _video3 = __webpack_require__(12);
	
	var _video4 = _interopRequireDefault(_video3);
	
	var _getVideoId = __webpack_require__(15);
	
	var _getVideoId2 = _interopRequireDefault(_getVideoId);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var Workarea = _backbone2.default.View.extend({
	    tagName: 'div',
	    className: 'workarea',
	    initialize: function initialize() {
	        _backbone2.default.on('addPicture', this._addPicture, this);
	        _backbone2.default.on('addVideo', this._addVideo, this);
	        _backbone2.default.on('moveObject', this._saveState, this);
	    },
	    _saveState: function _saveState() {
	        this.model.set('height', $(this.$el).prop('scrollHeight'));
	        $(this.$el).css('height', this.model.get('height'));
	    },
	    _addPicture: function _addPicture(src) {
	        var picture = new _picture4.default();
	
	        picture.set('src', src);
	        this.$el.append(new _picture2.default({ model: picture }).el);
	    },
	    _addVideo: function _addVideo(url) {
	        var video = new _video4.default();
	        var src = 'https://img.youtube.com/vi/' + (0, _getVideoId2.default)(url) + '/0.jpg';
	
	        video.set({
	            url: url,
	            src: src
	        });
	        this.$el.append(new _video2.default({ model: video }).el);
	    }
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _resizer = __webpack_require__(9);
	
	var _resizer2 = _interopRequireDefault(_resizer);
	
	var _resizer3 = __webpack_require__(13);
	
	var _resizer4 = _interopRequireDefault(_resizer3);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var Picture = _backbone2.default.View.extend({
	    tagName: 'div',
	    ...
	    initResizer: function initResizer() {
	        return new _resizer2.default({
	            model: new _resizer4.default({ mode: 'angle' })
	        });
	    },
	    initialize: function initialize() {
	        var _this = this;
	        ...
	        this.listenTo(this.resizer.model, 'change', function (event) {
	            _this.model.set({
	    ...
	    _moveStart: function _moveStart(event) {
	        var _this2 = this;
	    ...
	    _moveEnd: function _moveEnd() {
	        _backbone2.default.trigger('moveObject');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ResizerView = _backbone2.default.View.extend({
	    tagName: 'div',
	    className: 'resizer',
	    state: {
	        direction: null,
	    ...
	    template: {
	        angle: '<div class="resizer__item" data-direction="lt"></div>' + '<div class="resizer__item" data-direction="rt"></div>' + '<div class="resizer__item" data-direction="lb"></div>' + '<div class="resizer__item" data-direction="rb"></div>',
	        side: '<div class="resizer__item" data-direction="t"></div>' + '<div class="resizer__item" data-direction="l"></div>' + '<div class="resizer__item" data-direction="r"></div>' + '<div class="resizer__item" data-direction="b"></div>'
	    },
	    render: function render() {
	        var template = void 0;
	    ...
	    _resizeStart: function _resizeStart(event) {
	        var _this = this;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Toolbar = _backbone2.default.View.extend({
	    tagName: 'div',
	    className: 'toolbar',
	    initialize: function initialize() {
	        this.render();
	    ...
	    _addPicture: function _addPicture(event) {
	        var reader = new FileReader();
	        if (event.target.files.length) {
	            reader.readAsDataURL(event.target.files[0]);
	            reader.onloadend = function () {
	                _backbone2.default.trigger('addPicture', reader.result);
	            };
	        }
	    },
	    _addVideo: function _addVideo(event) {
	        var dialog = prompt("Ссылка на видео", "https://www.youtube.com/watch?v=o0PpZGAnBjA");
	        if (dialog) {
	            _backbone2.default.trigger('addVideo', dialog);
	        }
	    },
	    render: function render() {
	    ...
	    template: '<label class="toolbar__button toolbar__button_picture">' + '<input type="file" class="toolbar__button-input" value="" accept="image/*"/>Добавить фото' + '</label><button class="toolbar__button toolbar__button_video">Добавить видео</button>'
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Video = _picture2.default.extend({
	    defaults: _.extend({
	        url: ''
	    }, _picture2.default.prototype.defaults)
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ResizerModel = _backbone2.default.Model.extend({
	    defaults: {
	        width: 0,
	        height: 0,
	        top: 0,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Picture = _backbone2.default.Model.extend({
	    defaults: {
	        width: 300,
	        height: 300,
	        top: 0,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Video = _picture2.default.extend({
	    ...
	    initResizer: function initResizer() {
	        return new _resizer2.default({
	            model: new _resizer4.default({ mode: 'side' })
	        });
	    }
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Workarea = _backbone2.default.Model.extend({
	    defaults: {
	        height: null
	    }
	});
...
/***/ })
/******/ ]);
//# sourceMappingURL=main.js.map?hash=b32e87e50c2c0cc3fc47